        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="text-lg text-gray-700 leading-relaxed max-w-3xl mx-auto space-y-6">
              ...
              <p>
                Une démarche progressive, respectueuse de votre rythme, 
                qui s'adapte à vos besoins du moment.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-700">
                  Tester dans un cadre bienveillant ce qui fonctionne pour vous.
                </p>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              ...
              <div className="bg-white p-8 rounded-lg border border-gray-100">
                <h3 className="text-xl font-medium text-black mb-6">Nos principes</h3>
                <div className="space-y-4">
                  <div className="flex items-start">
                    <span className="text-aw-red mr-3">•</span>
                    <span className="text-gray-700">Simplicité accessible à tous</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-aw-red mr-3">•</span>
                    <span className="text-gray-700">Respect du rythme de chacun</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-aw-red mr-3">•</span>
                    <span className="text-gray-700">Utilité concrète immédiate</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-aw-red mr-3">•</span>
                    <span className="text-gray-700">Approche scientifique discrète</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-lg text-gray-700 mb-8 leading-relaxed">
              ...
              Échangeons ensemble sur ce qui pourrait vous convenir.
            </p>
            <Link
              href="/contact"
